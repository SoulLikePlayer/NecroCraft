package net.necrocraft.client.model.minion.skeleton;
...
public class BoggedMinionModel extends SkeletonMinionModel<SkeletonMinionRenderState> {
    private final ModelPart mushrooms;

    public BoggedMinionModel(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        SkeletonMinionModel.createDefaultSkeletonMesh(root);
